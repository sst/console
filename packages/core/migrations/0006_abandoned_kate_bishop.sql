...
ALTER TABLE `state_update` ADD CONSTRAINT `state_update_workspace_id_state_id_stage_workspace_id_id_fk` FOREIGN KEY (`workspace_id`,`state_id`) REFERENCES `stage`(`workspace_id`,`id`) ON DELETE no action ON UPDATE no action;